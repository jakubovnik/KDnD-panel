...
-- Generation Time: Jun 24, 2025 at 02:28 PM
...
(2, 'Hide object', 3, 8, 1),
(2, 'Life steal', 4, 45, 2),
(3, 'Brimstone skin', 4, 12, 0),
(3, 'Curse projectile', 0, 10, 1),
(3, 'Inspect', 3, 45, 3),
(3, 'Platform', 2, 5, 0),
(3, 'Touch of death', 5, 32, 1),
(4, 'Ability boost', 3, 20, 1),
(4, 'Artus', 4, 40, 1),
(4, 'Basic healing', 1, 5, 1),
(4, 'Basic Telepathy', 2, 0, 0),
(4, 'Basic understanding', 1, 20, 0),
(4, 'Charm', 4, 60, 1),
(4, 'Endure', 3, 20, 0),
(4, 'Fact', 5, 45, 1),
(4, 'Form Golem', 6, 15, 3),
...
(8, 'Communication network', 5, 15, 2);
...
(2, 'Gladiátor', 2, 1, 0, 0, 'Meč, který zvyšuje sílu nárazu o 50%', 0, 1, 1, 2),
...
(4, 'Zbroj vzdušných triků', 4, 1, 10, 10, 'Zbroj, pomocí které vlastník může dělat pohyby bez pevného povrchu o který by byla potřeba se opřít', 0, 0, 1, 2),
...
(8, 'Meč transformace', 2, 1, 11, 20, 'Původně meč který využíval kameny elementů, avšak po vstřebání křišťálu existence ztratil tento název. Po každém poškození živé bytosti absorbuje kámen na hrušce esenci a po dostatečném nabití se může transformovat na jakýkoliv tvar.', 0, 1, 1, 2),
(9, 'Meč chaosu', 2, 1, 5, 5, 'Meč který napodobuje sílu bohyně chaosu. Ignoruje většinu štítů a rozbíjí magii, jakoby byla fyzický objekt.', 0, 1, 1, 2),
...
(12, 'Prsten odpuštění', 7, 2, 0, 0, 'Když nositel tohoto prstene selže ve vyvolávání kouzla, efekty selhání neproběhnou, avšak prsten se rozbije.', 0, 1, 1, 2),
...
(18, 'Šperky', 1, 3, 0, 0, 'Šperky z pokladnice původního Abzhiánu.', 0, 0, 0, 2),
...
(21, 'Křišťál chaosu', 11, 25, 0, 0, 'Křišťál držící sílu chaosu', 0, 0, 0, 2),
(22, 'Kus zdi', 1, 1, 0, 0, 'zeď ??? (Občas se podivně kroutí)', 0, 0, 0, 2),
...
(36, 'Kniha Life Steal', 1, 1, 0, 0, 'Life steal goes brrr', 0, 0, 0, 2),
(37, 'Kámen co mě má rád', 1, 1, 0, 0, '(spadl mi na hlavu)', 0, 0, 0, 2),
(38, 'Granát Statiky', 2, 5, 3, 3, 'Granát který po aktivaci zastaví pohyb 1 metr okolo sebe. Každý granát má 3 použití.', 0, 0, 0, 2),
...
(40, 'Džbán piva', 9, 1, 8, 20, 'Pivo', 0, 1, 0, 2),
...
(50, '1/4 Gertúda', 9, 1, 1, 1, 'Asi zadní pravá noha idk', 0, 0, 0, 2),
(51, 'Sušený maťo a chleba', 9, 1, 10, 15, 'Mňam mňam ', 0, 0, 0, 2),
...
(58, 'Krystal lásky', 11, 1, 4, 4, 'Krystal lásky', 0, 0, 0, 2),
(59, 'Křišťál lásky', 11, 1, 0, 0, 'Odměna za kytky pro Arlu', 0, 0, 0, 3),
(60, 'Performance enhance lektvar', 9, 4, 5, 5, '-//-', 0, 0, 0, 2),
(61, 'Pálivec', 9, 1, 15, 20, 'Chlast ze zemí démonů', 0, 0, 0, 2),
(62, 'Likér', 9, 1, 15, 15, 'Idk', 0, 0, 0, 2),
...
(83, 'Křišťál chaosu', 11, 1, 0, 0, 'Oscar díky tomu může se svým mečem Chaosu zjistit moji polohu', 0, 0, 0, 3),
(84, 'Kr. Meč', 2, 1, 0, 0, 'Jednoduchá ocel', 0, 0, 1, 4);
...
(9, 'Chaos effect', 'Chaos', 5, 25, 1, '-', '- Implements randomness (d20) into any action', '-', '- #static-spell \r\n- #Advanced-concept \r\n- #magic-system-1', '- Somewhat useless now that we roll for everything :P', 0),
...
(31, 'Orb of shielding', 'Order', 2, 10, 1, '- needs a target that is to be shielded', '- creates a sphere made up of shielding matter that blocks most attacks', '-', '- #static-spell \r\n- #Intermediate-concept \r\n- #magic-system-1', '-', 0),
...
(48, 'Re-Routing', 'Existence', 1, 10, 0, '-', '- Changes the target or direction of a spell while the spell is active\r\n- Can be activated multiple times during the spells lifetime', '-', '- #dynamic-mod\r\n- #Intermediate-concept\r\n- #casting-exchange\r\n- #magic-system-1', '-', 1),
...
(68, 'Soul', '<h1>Description</h1>\n<p>Every being alive has a soul made of three parts</p>\n\n<h2>Shell</h2>\n\n<h2>Outer core</h2>\n\n<h2>Inner core</h2>\n\n\n<h1>Function</h1>\n\n<h2>Shell</h2>\n\n<h2>Outer core</h2>\n\n<h2>Inner core</h2>\n\n\n<h1>Exceptions</h1>', '#magic#unfinished', 1, ';Eryn;'),
...
(75, 'Human', '<p>A regular human.... thats it.</p>\n<br>\n<br>\n<br>\n<br>\n<br>\n<br>\n<br>\n<br>\n<p>what more do you want?</p>', '#species#unfinished', 4, ';'),
