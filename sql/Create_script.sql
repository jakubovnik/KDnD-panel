...
-- Table `kdnd`.`calendar`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kdnd`.`calendar` ;

CREATE TABLE IF NOT EXISTS `kdnd`.`calendar` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `date` DATE NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
...
-- -----------------------------------------------------
-- Table `kdnd`.`character_calendar`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kdnd`.`character_calendar` ;

CREATE TABLE IF NOT EXISTS `kdnd`.`character_calendar` (
  `character_id` INT UNSIGNED NOT NULL,
  `calendar_id` INT UNSIGNED NOT NULL,
  `available` TINYINT UNSIGNED NOT NULL,
  `note` VARCHAR(255) NULL,
  PRIMARY KEY (`character_id`, `calendar_id`),
  INDEX `character_calendar_calendar1_idx` (`calendar_id` ASC),
  INDEX `character_calendar_character1_idx` (`character_id` ASC),
  CONSTRAINT `character_calendar_character1`
    FOREIGN KEY (`character_id`)
    REFERENCES `kdnd`.`character` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `character_calendar_calendar1`
    FOREIGN KEY (`calendar_id`)
    REFERENCES `kdnd`.`calendar` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
