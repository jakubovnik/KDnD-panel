...
CREATE TABLE IF NOT EXISTS `kdnd`.`character_magic` (
  ...
  INDEX `character_magic_magic1_idx` (`magic_name` ASC),
  CONSTRAINT `character_magic_character1`
    FOREIGN KEY (`character_id`)
    REFERENCES `kdnd`.`character` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `character_magic_magic1`
    FOREIGN KEY (`magic_name`)
    REFERENCES `kdnd`.`magic` (`name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
